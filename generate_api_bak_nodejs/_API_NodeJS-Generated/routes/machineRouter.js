...
machineRouter.route('/findall').get((req, res) => {
...
machineRouter.route('/find/:id').get((req, res) => {
...
machineRouter.route('/update/:id').post((req, res) => {
    machine.findById(req.params.id, (err, machineInstance) => {
        if (!machineInstance) {
            ...
            machineInstance .a1=req.body.a1;machineInstance .a2=req.body.a2;machineInstance .a3=req.body.a3;
