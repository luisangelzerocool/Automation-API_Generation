...
invoiceRouter.route('/findall').get((req, res) => {
...
invoiceRouter.route('/find/:id').get((req, res) => {
...
invoiceRouter.route('/update/:id').post((req, res) => {
    invoice.findById(req.params.id, (err, invoiceInstance) => {
        if (!invoiceInstance) {
            ...
            invoiceInstance .a1=req.body.a1;invoiceInstance .a2=req.body.a2;invoiceInstance .a3=req.body.a3;
